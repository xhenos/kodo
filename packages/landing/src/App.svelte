  ...
  <div class="container">
    <div class="branding">
      ...
      <h1 class="description">
        Tachiyomi is an open-source Android app that lets you read any manga from
        your smartphone – faster and easier than ever.
      </h1>
    </div>
    <div class="features">
      <div class="feature-tracking">
        ...
        <div class="image-tracking">
          <img height="256px" src="https://i.imgur.com/zVq59EO.png" alt="Placeholder">
        </div>
      </div>
      <div class="feature-extensions">
        <div class="image-extensions">
          <img height="256px" src="https://i.imgur.com/gyW9P1C.png" alt="Placeholder">
        </div>
        <div class="description-extensions">
          <h2>
            Extensions
          </h2>
          <span>
      ...
      <div class="feature-customization">
        <div class="description-customization">
          <h2>
            Customization
          </h2>
          <span>
        ...
        <div class="image-customization">
          <img height="256px" src="https://i.imgur.com/M5Jdc8t.png" alt="Placeholder">
        </div>
      </div>
    </div>
  </div>
...
.feature-tracking {
  ...
  grid-auto-flow: row;
  grid-template-areas:
    "description-tracking image-tracking";
  grid-area: feature-tracking;
}
.description-tracking {
  grid-area: description-tracking;
  text-align: right;
  padding: 0.25rem 1rem 0.25rem 8rem;
}
.image-tracking {
  grid-area: image-tracking;
  text-align: left;
  padding: 0.25rem;
}
...
.feature-extensions {
  ...
  grid-auto-flow: row;
  grid-template-areas:
    "image-extensions description-extensions";
  grid-area: feature-extensions;
}
.description-extensions {
  grid-area: description-extensions;
  text-align: left;
  padding: 0.25rem 8rem 0.25rem 1rem;
}
.image-extensions {
  grid-area: image-extensions;
  text-align: right;
  padding: 0.25rem;
}
...
.feature-customization {
  ...
  grid-auto-flow: row;
  grid-template-areas:
    "description-customization image-customization";
  grid-area: feature-customization;
}
.description-customization {
  grid-area: description-customization;
  text-align: right;
  padding: 0.25rem 1rem 0.25rem 8rem;
}
.image-customization {
  grid-area: image-customization;
  text-align: left;
  padding: 0.25rem;
}
