		...
		<div class="pt-8 md:pt-16">
			<div class="flex flex-col items-center">
				<div class="flex flex-col items-center mb-2 text-ui-primary">
					<Logo :width="80" />
					<h2 class="text-3xl text-6xl font-medium tracking-tighter border-none">
						{{ meta.siteName }}
					</h2>
				</div>
				<h1 class="text-xl font-normal text-center lg:text-3xl">
				...
				<div class="w-full md:w-auto flex flex-col md:flex-row justify-center mt-8">
					<g-link
						to="/download/"
						class="flex order-1  items-center place-content-center px-6 w-10/12 md:w-auto py-4 mx-auto md:mr-2 text-2xl font-bold leading-none text-white border rounded-lg shadow-lg bg-ui-primary border-ui-primary transition-all duration-200 ease-out transform hover:shadow-xl hover:-translate-y-1"
					>
					...
					<g-link
						...
						class="flex order-2 items-center place-content-center px-6 w-10/12 md:w-auto py-4 mx-auto mt-2 md:mt-auto text-2xl font-bold leading-none text-white border rounded-lg shadow-lg bg-ui-primary border-ui-primary transition-all duration-200 ease-out transform hover:shadow-xl hover:-translate-y-1"
					>
